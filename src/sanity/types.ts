...
// Query: *[_type=="startup" && defined(slug.current) && !defined($search)  || category match $search || title match $search || author -> name match $search ] | order(_createdAt desc){    _id,    title,    description,     slug,    _createdAt,    _updatedAt,    author -> {     _id,name,image,bio, username    },    views,    category,     image, }
...
// Query: *[_type == "startup" && _id ==$id][0]{     _id,    title,    description,     slug,    _createdAt,    _updatedAt,    author -> {     _id,name,image,bio     },    views,    category,     image,     pitch }
